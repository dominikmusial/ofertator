"""Castorama (Mirakl) marketplace provider implementation"""
...
from .config import CASTORAMA_CONFIG
import logging
...
class CastoramaMarketplaceClient:
    """
    Castorama marketplace client using shared Mirakl infrastructure.
    ...
    def __init__(self, api_key: str, shop_id: Optional[str] = None):
        ...
        # Compose Mirakl API client with Castorama config
        self._api_client = MiraklAPIClient(
            api_key=self.api_key,
            shop_id=self.shop_id,
            base_url=self._config.base_url
        )
        logger.info(f"Initialized CastoramaMarketplaceClient with shop_id: {self.shop_id}")
    
    # ===== Core Methods =====
    
    def create_offer(self, offer_data: dict) -> dict:
        """
        Create new offer on Castorama/Mirakl
    ...
    def get_offer(self, offer_id: str) -> dict:
        """
        Get offer details from Castorama/Mirakl
    ...
    def update_offer(self, offer_id: str, updates: dict) -> dict:
        """
        Update existing offer on Castorama/Mirakl
    ...
    def upload_image(self, image_bytes: bytes, filename: str) -> str:
        """
        Upload image to Castorama/Mirakl
    ...
    def get_categories(self, parent_id: Optional[str] = None) -> List[dict]:
        """
        Get categories from Castorama/Mirakl
    ...
    def get_marketplace_type(self) -> MarketplaceType:
        ...
        return MarketplaceType.castorama
    
    def get_capabilities(self) -> dict:
        """Return Castorama/Mirakl capabilities"""
        return {
    ...
    # Castorama-specific methods (not in interface) - can be added if needed
    ...
    def get_orders(
        ...
        """
        Castorama-specific: Get orders for reporting
