"""Leroy Merlin products API endpoints"""
...
def get_hierarchies(
    ...
    Query Parameters:
        - account_id: Leroy Merlin account ID (required)
    ...
    if not account or account.marketplace_type != models.MarketplaceType.leroymerlin:
        raise HTTPException(status_code=404, detail="Leroy Merlin account not found")
