"""Castorama products API endpoints"""
...
def get_hierarchies(
    ...
    Query Parameters:
        - account_id: Castorama account ID (required)
    ...
    if not account or account.marketplace_type != models.MarketplaceType.castorama:
        raise HTTPException(status_code=404, detail="Castorama account not found")
